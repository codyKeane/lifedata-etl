...
## Baseline — 2026-03-26 15:18

**Hardware:** 12th Gen Intel(R) Core(TM) i7-12700H | RAM: 33G | Disk: nvme1n1 (SSD/NVMe, 1.8T) Samsung SSD 970 EVO Plus 2TB; nvme0n1 (SSD/NVMe, 953.9G) WD PC SN560 SDDPNQE-1T00-1002


| Test | Dataset | Duration (s) | Throughput |
|------|---------|-------------|------------|
| test_parse_large_csv | 100,000 rows | 0.745 | 134,144 rows/sec |
| test_insert_10k_events | 10,000 events | 0.172 | 58,128 events/sec |
| test_daily_summary_query_at_scale | 500,000 events / 180 days | 0.001 | 5 groups in 0.001s |
| test_correlation_query_at_scale | 500,000 events / 30 days | 0.028 | 47 aligned days in 0.028s |
